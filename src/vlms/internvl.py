...
class InternVLEvaluator(VLMEvaluator):
    ...
    def load_vlm(self, *args, **kwargs):
        device_map = split_model(self.vlm_name.split('/')[-1])
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(self.vlm_name, trust_remote_code=True, use_fast=False)
